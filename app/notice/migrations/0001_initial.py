    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tz', models.CharField(default='UTC', max_length=50, verbose_name='client time zone')),
            ],
            options={
                'verbose_name': 'Client',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('created', 'Created'), ('sended', 'Success'), ('error', 'Error'), ('canceled', 'Canceled')], default='created', max_length=50, verbose_name='status')),
                ('client_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='notice.client', verbose_name='client')),
